...
<head>
    ...
    <link rel="stylesheet" href="./Signup_verification/signup_verification.css">
</head>
<body>
    ...
    <div class="Verification">
        ...
        <div class="Input_division">
            ...
            <form action="./Signup_verification/signup_verification_data.php" method="POST">
                ...
                <div class="Input_option_division">
                    ...
                    <div class="input-group mb-3">
                        ...
                        aria-label="Username" aria-describedby="basic-addon1" name="verification_code" required>
                    </div>        
                
                    <!-- Signup button  -->
                    <button class="Submit_button" name="verifycode">Submit</button>
